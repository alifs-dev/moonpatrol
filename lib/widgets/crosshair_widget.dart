...
// ============================================================
// EXEMPLES D'UTILISATION dans camera_screen.dart
// ============================================================
...
Stack(
  children: [
    ...
    SensorOverlayWidget(sensorData: _sensorData),
    CrosshairWidget(), // ← Ajout simple
  ],
)

// Exemple 2 : Personnalisation basique
Stack(
  children: [
    CameraPreview(_controller),
    SensorOverlayWidget(sensorData: _sensorData),
...
// Exemple 5 : Avec animation pulsante
class CameraScreenWithAnimatedCrosshair extends StatefulWidget {
  @override
  State<CameraScreenWithAnimatedCrosshair> createState() => 
      _CameraScreenWithAnimatedCrosshairState();
}

class _CameraScreenWithAnimatedCrosshairState 
    extends State<CameraScreenWithAnimatedCrosshair> 
